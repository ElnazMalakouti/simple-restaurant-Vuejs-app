...
<template>
    <div class="w-[400px] bg-[#F0F8FF] p-[16px] rounded-[16px] flex flex-col gap-[16px] justify-start items-center">
        ...
        <div class="w-full min-h-[100px] max-h-[252px] px-[16px] flex flex-col justify-center items-center gap-[4px] overflow-auto">

            <div class="w-full p-[12px] bg-white rounded-[8px] flex flex-col justify-between items-start" v-for="order in orderList"> 
                <div>
